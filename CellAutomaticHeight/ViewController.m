...
-(NSString *)getRandomStr
{
    ...
    NSString *sourceStr = @"美光方面周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置周二表示，尚未收到竞争对手台联电早些时候提到的在中国大陆销售芯片的临时禁令。美光表示，在评估来自福州中级人民法院的文件之前，该公司不会对此置评";
    NSMutableString *resultStr = [[NSMutableString alloc] init];
//    srand(time(0));
    kNumber = rand() % [sourceStr length];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.contentLabel.text = [self getRandomStr];;
    cell.timeLabel.text = [self getRandomStr];
    cell.nicknameLabel.text = [self getRandomStr];
